...
import { Business } from '../org.poc.comp';
import 'rxjs/Rx';
...
export class BusinessService {
  ...
  private NAMESPACE_HISTORY: string = 'System/Historian';




  constructor(private dataService: DataService<Business>, private dataService2: DataService<HistorianRecord>) {
  };
  ...
  public getAllHistory(): Observable<HistorianRecord[]> {
    return this.dataService2.getAll(this.NAMESPACE_HISTORY);
  }
